...
export function renderEquipmentPanel() {
  ...
  function makeSection(title, { fillSlotKeys, onClear, upgradeFills } = {}) {
    ...
    if (fillEntries.length && !_readOnly) {
      ...
      fillBtn.type = "button";
      fillBtn.className = "axi-btn equip-fill-btn" + (fillEntries.length > 1 ? " equip-fill-btn--dropdown" : "");
    ...
    if (onClear && !_readOnly) {
      ...
      clearBtn.className = "axi-btn equip-fill-btn equip-clear-btn";
  ...
  clearAllBtn.className = "axi-btn equip-fill-btn equip-clear-btn equip-clear-all-btn";
